...
If nfolha==1
	If lMv_Logod
		oDanfe:SayBitmap(067,010,cLogoD,060,030)
	Else
		oDanfe:SayBitmap(067,010,cLogo,060,030)
	EndIF
Endif
...
For nY := 1 To nLenItens
	...
	If lflag
		If nL > nMaxItemP2
			...
			If lMv_Logod
				oDanfe:SayBitmap(067+nLinhavers,010,cLogoD,060,030)
			Else
				oDanfe:SayBitmap(067+nLinhavers,010,cLogo,060,030)
			EndIf
