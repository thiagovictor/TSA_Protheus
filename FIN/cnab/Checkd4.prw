...
±±³Programa  ³ Checkd4  ³ Autor ³Ricardo E. Rodrigues   ³ Data ³ 27/01/04 ³±±
...
±±³Uso       + Geracao de CNAB de pagamentos-Bordero modelo 98             ±±
±±³          + DARF     								                   ±±  
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
*/

User Function Checkd4
*****************************************************************************
* Rotina de Calculo
********************
...
//nd1		:=  strzero(dtoc(gravadata(ddatabase,.F.,1)),17) + "0"
//nd1		:= strzero(VAL(SEA->EA_MODELO+SE2->E2_NUM) + "0")),18)
nd1		:= STRZERO(VAL(SEA->EA_NUMBOR+SEA->EA_NUM+SEA->EA_MODELO),17)+ "0"
//nd1		:=  strzero(val(alltrim(strtran(str(dtoc(ddatabase)),"/",""))),17) + "0"
//(strtran(str(SE2->E2_PRECEIT),".","")
