/*
+-------------------------------------------------------------------------+-------+-----------+
¦Programa  ¦LDREVDOC ¦ Autor ¦ Crislei de Almeida Toledo                  | Data  ¦ 23.08.2007¦
+----------+--------------------------------------------------------------+-------+-----------+
...
//   cParam := cCodProj+";"+DTOC(dDtPrvIni)+";"+DTOC(dDtPrvFim)+";"+cTarInic+";"+cTarFina+";"+cNumClie+";"+cNumEPC+";"+Str(nLstDocs,1)+";"+cSbDisIni+";"+cSbDisFim+";"+Str(nRevisao,1)+";"+DTOC(dDtPrvIni)+";"+DTOC(dDtPrvFim)+";"+cRevLD
   ...
   CallCrys("LDREV1",cParam) //,cOptions)   
Else
